...
import { Radio, Button, Select, Option, TextInput } from 'jimu-ui'; // Removed Checkbox import for now
...
const Widget = (props: AllWidgetProps<unknown>) => {
  ...
  // NEW: State for managing available layers (no selected layers state yet)
  ...
  useEffect(() => {
    if (jimuMapView && jimuMapView.view) {
      ...
      // NEW: Populate available layers when jimuMapView is ready and log them
